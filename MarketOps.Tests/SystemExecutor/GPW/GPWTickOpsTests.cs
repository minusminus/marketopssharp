...
namespace MarketOps.Tests.SystemExecutor.GPW
{
    [TestFixture]
    public class GPWTickOpsTests
    {
        private readonly GPWTickOps _testObj = new GPWTickOps(0);
        ...
        [TestCase(200, 1, 202f)]
        [TestCase(500, 1, 505f)]
        [TestCase(1000, 1, 1010f)]
        [TestCase(2000, 1, 2020f)]
        [TestCase(5000, 1, 5050)]
        [TestCase(10000, 1, 10100)]
        [TestCase(20000, 1, 20200)]
        [TestCase(50000, 1, 50500)]
        ...
        [TestCase(200, -1, 198f)]
        [TestCase(500, -1, 495f)]
        [TestCase(1000, -1, 990f)]
        [TestCase(2000, -1, 1980f)]
        [TestCase(5000, -1, 4950)]
        [TestCase(10000, -1, 9900)]
        [TestCase(20000, -1, 19800)]
        [TestCase(50000, -1, 49500)]
